...
class Human36M:
    def __init__(self, data_split):
        ...
        self.img_dir = osp.join('/root/repo/nanxinyu/Light_3DHPE/data/Human36M/images/images')
        self.annot_path = osp.join('/root/repo/nanxinyu/Light_3DHPE/data/Human36M/annotations')
